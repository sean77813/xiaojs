package com.sean.units.websocket;
...
public class WebSocketClinet {
    ...
    final static Logger logger= LogManager.getLogger(WebSocketClinet.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocketClinet myClient = new WebSocketClinet();
        //读取配置文件
...
//        }
    ...
    public void runStompClient(WebSocketClinet client,String URI,String subscribe,String send, final String sendMsg) throws ExecutionException, InterruptedException, UnsupportedEncodingException {
        ...
        StompSession.Receiptable rec= stompSession.send(send,sendMsg.getBytes("UTF-8"));
        //添加消息发送成功的回调
